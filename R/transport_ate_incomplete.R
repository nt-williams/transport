...
transport_ate_incomplete <- function(transport_Npsem, learners, family, ...) {
    ...
    pred_S <- regress_predict(fit_S, transport_Npsem$var("V"))
    ...
    pred_Pseudo_1 <- regress_predict(fit_Pseudo_1, transport_Npsem$modify("S", 1)$data[, c(transport_Npsem$S, transport_Npsem$V)])

    fit_Pseudo_0 <- regress(transport_Npsem$data[, c(transport_Npsem$S, transport_Npsem$V)],
                            pred_Y_0, learners, "continuous", 10)
    pred_Pseudo_0 <- regress_predict(fit_Pseudo_0, transport_Npsem$modify("S", 1)$data[, c(transport_Npsem$S, transport_Npsem$V)])
