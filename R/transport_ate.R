#' Transport Estimator for the Average Treatment Effect
#'
#' One-step transport estimator for the average treatment effect (ATE)
...
#'
#' @seealso [.transport_ate_control()].
#'
#' @return
#' @export
#'
#' @examples
transport_ate <- function(data, trt, outcome, source, covar, cens = NULL,
                          outcome_type = c("binomial", "continuous"),
                          id = NULL, weights = NULL,
                          control = .transport_ate_control()) {
